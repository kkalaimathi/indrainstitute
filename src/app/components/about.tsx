...
const Aboutus = () => {
    ...
    return (
        <section id="about" className="bg-yellow-50 py-8 lg:py-16"><br />
                <h2 className="text-4xl font-bold text-center text-red-500 mb-10 lg:mb-20">About Us</h2>
                <div className="container mx-auto p-4 flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-0">
                    <div className="flex lg:w-1/2 flex-wrap items-center justify-center gap-4">  
                        <Image src={"/aboutimg.png"} width={1000} height={1000} alt="image1" className="w-[600px] h-auto rounded-xl"/>
                     </div>
                     <div className="flex lg:w-1/2 flex-col items-start justify-center lg:gap-4">  
                ...
                {/* <div className="md:grid md:grid-cols-2 gap-4 mt-8">
                    <div className="grid grid-cols-2 gap-4 p-4">
                        {images.map((image, index) => (
                            <div
                                key={index}
                                className="bg-cover bg-center flex rounded-lg lg:w-80 lg:h-72 sm:h-80 md:h-96 w-full h-64"
                    ...
                    <div className="flex flex-col items-start p-4 space-y-4 w-full">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-11 p-4">
                            ...
                            <div className="flex flex-col ">
                                <h3 className="text-xl text-teal-600 text-center lg:text-left font-bold mb-4">Choreography & Performance Workshops</h3>
